...
import { Bookmark as BookmarkIcon, LayoutGrid, List } from "lucide-react";
...
function BookmarksComponent() {
	...
	const currentCollectionName = useMemo(() => {
		...
		// Find the collection name from bookmarkCollections
	...
	return (
		<div className="flex h-full flex-col">
			...
			<EditBookmarkDialog
				bookmark={bookmarks.find((b: any) => b.id === editingBookmark) || null}
