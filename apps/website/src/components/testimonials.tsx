...
const TestimonialCard = ({
	...
	return (
		<div className="relative w-full max-w-xs overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] p-10 shadow-[0px_2px_0px_0px_rgba(255,255,255,0.1)_inset]">
			<div className="absolute -top-5 -left-5 -z-10 h-40 w-40 rounded-full bg-gradient-to-b from-[#e78a53]/10 to-transparent blur-md" />
			...
			<div className="mt-5 flex items-center gap-2">
				...
				<div className="flex flex-col">
					<div className="font-medium text-white leading-5 tracking-tight">
						{name}
					</div>
					<div className="text-white/60 leading-5 tracking-tight">
						{username}
					</div>
				</div>
			</div>
...
export function TestimonialsSection() {
	return (
		<section id="testimonials" className="m-24">
			<div className="mx-auto max-w-7xl">
				<div className="mx-auto max-w-[540px]">
					<div className="flex justify-center">
						...
						>
							<div className="absolute inset-x-0 -top-px mx-auto h-0.5 w-1/2 bg-gradient-to-r from-transparent via-[#e78a53] to-transparent shadow-2xl transition-all duration-500 group-hover:w-3/4" />
							<div className="absolute inset-x-0 -bottom-px mx-auto h-0.5 w-1/2 bg-gradient-to-r from-transparent via-[#e78a53] to-transparent shadow-2xl transition-all duration-500 group-hover:h-px" />
							<span className="relative text-white">Testimonials</span>
						</button>
					</div>
					<h2 className="__className_bb4e88 relative z-10 mt-5 bg-gradient-to-r from-foreground/60 via-foreground to-foreground/60 bg-clip-text text-center font-semibold text-4xl text-transparent tracking-tighter md:text-[54px] md:leading-[60px] dark:from-muted-foreground/55 dark:via-foreground dark:to-muted-foreground/55">
						What our users say
					</h2>
					...
					<p className="relative z-10 mt-5 text-center text-lg text-zinc-500">
						...
						BookmarkReader simplifies their digital life.
					</p>
				</div>
				...
				<div className="-mt-8 flex justify-center">
					<Button className="group relative inline-flex items-center gap-2 rounded-full border border-[#e78a53]/30 bg-black/50 px-6 py-3 font-medium text-sm text-white transition-all hover:border-[#e78a53]/60 hover:bg-[#e78a53]/10 active:scale-95">
						<div className="absolute inset-x-0 -top-px mx-auto h-px w-3/4 bg-gradient-to-r from-transparent via-[#e78a53]/40 to-transparent" />
						<div className="absolute inset-x-0 -bottom-px mx-auto h-px w-3/4 bg-gradient-to-r from-transparent via-[#e78a53]/40 to-transparent" />
						<svg
